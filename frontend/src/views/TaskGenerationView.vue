...
import { isGenerationActive, jobLabels, reconcileApps, stageLabel, unitLabel, type AppSelection } from '@/utils/taskGeneration'
...
<template>
  <div class="page task-generation-page">
    ...
    <section v-show="mode === 'records'" class="generation-panel" aria-label="生成记录">
      <div class="records-toolbar"><h2>生成记录</h2><el-button text :icon="Refresh" :loading="refreshing" @click="review.refreshJobs">刷新记录</el-button></div>
