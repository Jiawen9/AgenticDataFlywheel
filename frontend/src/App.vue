...
import { ArrowDown, Collection, Cpu, DataAnalysis, Document, EditPen, House, Iphone, MagicStick, Operation, PieChart, Plus, Promotion, Share, TrendCharts, Upload, VideoPlay } from '@element-plus/icons-vue'

const expertExpanded = ref(true)
const taskGenerationExpanded = ref(true)
const collectionExpanded = ref(true)
const correctionExpanded = ref(true)
const modelTrainingExpanded = ref(true)
const route = useRoute()
const taskGenerationActive = computed(() => route.path.startsWith('/task-generation'))
        ...
        <section class="nav-group nav-group--expert">
          ...
          <div v-show="expertExpanded" class="nav-group__items">
            <div class="nav-subgroup">
              <button class="nav-subgroup__toggle" :class="{ active: taskGenerationActive }" type="button" @click="taskGenerationExpanded = !taskGenerationExpanded">
                <span class="nav-group__toggle-label"><el-icon><Plus /></el-icon><span>任务生成</span></span>
            ...
            <div class="nav-subgroup">
              ...
              <div v-show="modelTrainingExpanded" class="nav-tertiary-items">
                ...
                <router-link to="/model-training/launch"><el-icon><VideoPlay /></el-icon><span>训练启动</span></router-link>
              </div>
            </div>
