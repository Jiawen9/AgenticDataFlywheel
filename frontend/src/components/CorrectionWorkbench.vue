...
.action-text{display:block;font-size:11px;white-space:pre-wrap;overflow-wrap:anywhere;color:#334155}.steps :deep(.is-deleted){opacity:.5;background:#fff1f2}.steps :deep(.el-table__row){cursor:pointer}
